...
start "FinFlow Backend" cmd /c "title FinFlow Backend && call venv\Scripts\activate.bat && uvicorn backend.main:app --reload"

echo - Starting Frontend Server...
start "FinFlow Frontend" cmd /c "title FinFlow Frontend && cd frontend && npm run dev"
